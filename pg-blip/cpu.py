...
example_image = Image.open('images/wrench.jpg').convert("RGB")
#example_image = Image.open('towle.jpg').convert("RGB")
...
question_samples = {
    ...
    #'prompt': 'Question: Classify this object as filled or, empty? Respond unknown if you are not sure. Short answer:',
    #'prompt': 'Question: Classify this object as crushable or, non-crushable? Respond unknown if you are not sure. Short answer:',
